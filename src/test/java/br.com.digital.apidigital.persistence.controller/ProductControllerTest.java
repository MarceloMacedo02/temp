...
import br.com.digital.apidigital.controller.ProductController;
...
public class ProductControllerTest {
    ...
    public void findAllByPage() throws Exception {
        ...
        Mockito.when(productService.findByCondition(ArgumentMatchers.any(), ArgumentMatchers.any())).thenReturn(page);
    ...
    public void getById() throws Exception {
        Mockito.when(productService.findById(ArgumentMatchers.anyLong())).thenReturn(ProductBuilder.getDto());
    ...
    public void save() throws Exception {
        Mockito.when(productService.save(ArgumentMatchers.any(ProductDto.class))).thenReturn(ProductBuilder.getDto());
    ...
    public void update() throws Exception {
        Mockito.when(productService.update(ArgumentMatchers.any(), ArgumentMatchers.anyLong())).thenReturn(ProductBuilder.getDto());
        ...
        mockMvc.perform(
                        MockMvcRequestBuilders.put(ENDPOINT_URL + "/1")
                                ...
                                .content(CustomUtils.asJsonString(ProductBuilder.getDto())))
                .andExpect(MockMvcResultMatchers.status().isOk());
        Mockito.verify(productService, Mockito.times(1)).update(ArgumentMatchers.any(ProductDto.class), ArgumentMatchers.anyLong());
        Mockito.verifyNoMoreInteractions(productService);
    }
    ...
    public void delete() throws Exception {
        ...
        mockMvc.perform(
                MockMvcRequestBuilders.delete(ENDPOINT_URL + "/1")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(CustomUtils.asJsonString(ProductBuilder.getIds()))).andExpect(MockMvcResultMatchers.status().isOk());
